export const initialData = {
  ...
  femenino: {
    ...
    teams: [
      { id: 1, name: 'Ambi FC', group: 'A' },
      { id: 2, name: 'Biotec United', group: 'A' },
      { id: 3, name: 'Agro FC', group: 'A' },
      { id: 4, name: 'Admin', group: 'A' },

      { id: 5, name: 'ICO FC', group: 'B' },
      { id: 6, name: 'Materiales', group: 'B' },
      { id: 7, name: 'Agricola', group: 'B' },
      { id: 8, name: 'Resistencia', group: 'B' },
    ],
